...
import { Module, ClientStatus, CertificateStatus, UserRole, QuoteStatus, ServiceOrder } from './types';
  ...
  return (
    <Routes>
      ...
      <Route path="/qualidade" element={
        <Layout>
          <RBACGuard allowedRoles={[UserRole.REVISOR, UserRole.RESPONSAVEL_TECNICO, UserRole.ADMIN]}>
      ...
      <Route path="/tecnico" element={
        <Layout>
          <RBACGuard allowedRoles={[UserRole.TECNICO, UserRole.RESPONSAVEL_TECNICO, UserRole.ADMIN]}>
