...
export default function GeneralRegistersModule({
  ...
  // Employee State
  const [employeeForm, setEmployeeForm] = useState<Omit<Employee, 'id'>>({ nome: '', username: '', cargo: '', email: '', telefone: '', permissions: [], password: '', signatureBase64: '', isSignatory: false });
  ...
  const handleSaveEmployee = () => {
    ...
    setEmployeeForm({ nome: '', username: '', cargo: '', email: '', telefone: '', permissions: [], password: '', signatureBase64: '', isSignatory: false });
